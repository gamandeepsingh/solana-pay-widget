...
export const PaymentMethods: React.FC<PaymentMethodsProps> = ({
  ...
  const getMethodDescription = (methodId: string) => {
    switch (methodId) {
      case 'solana':
        return 'Connect your Solana wallet to pay instantly';
      case 'qr':
      ...
      <div className="sp-payment-methods-grid">
        {methods.map((method) => (
          ...
          >
            ...
            <div className="sp-payment-method-content">
              <div className="sp-payment-method-name">{method.name}</div>
              <div className="sp-payment-method-description">
